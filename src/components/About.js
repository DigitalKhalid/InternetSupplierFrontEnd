    ...
    return (
        <div>
            <p className="paragraph">
                BizzISP Manager is a simple and interactive application for internet service providers to manage connections and business activities among customers and dealers. The focus is to minimize efforts to keep track of package subscriptions and their renewal.
            </p>
            <p className="paragraph">
